...
class AppColors {
  ...
  static const Color darkBrown = Color(0xFF795548);
  static const Color grey = Color(0xFF303943);
  ...
  static const Color softGrey = Color(0xFFEAEAEA);
  static const Color neonGreen = Color(0xFF00FD8F);
  static const Color darkPurple = Color(0xFF401A55);
}